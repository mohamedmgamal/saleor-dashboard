...
import { createFilterStructure } from "@saleor/suppliers/components/SupplierListPage";
import { SupplierListUrlFilters } from "@saleor/suppliers/urls";
...
describe("Filtering query params", () => {
  it("should be empty object if no params given", () => {
    const params: SupplierListUrlFilters = {};
