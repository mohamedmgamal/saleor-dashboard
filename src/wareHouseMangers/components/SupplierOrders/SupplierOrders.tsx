...
import { SupplierDetails_user_orders_edges_node } from "../../types/WareHouseMangerDetails";
...
export interface SupplierOrdersProps {
  orders: SupplierDetails_user_orders_edges_node[];
  onViewAllOrdersClick: () => void;
  onRowClick: (id: string) => void;
}

const SupplierOrders: React.FC<SupplierOrdersProps> = props => {
...
SupplierOrders.displayName = "SupplierOrders";
