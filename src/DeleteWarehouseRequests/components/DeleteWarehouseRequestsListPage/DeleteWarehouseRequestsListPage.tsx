...
const DeleteWarehouseRequestsListPage: React.FC<ExistProductsListPageProps> = ({
  currencySymbol,
  currentTab,
  filterOpts,
  initialSearch,
...
DeleteWarehouseRequestsListPage.displayName = "DeleteWarehouseRequestsListPage";
export default DeleteWarehouseRequestsListPage;
