...
import { SupplierAddresses_user_addresses } from "../../types/SupplierAddresses";

export interface SupplierAddressDialogProps {
  address: SupplierAddresses_user_addresses;
...
const SupplierAddressDialog = withStyles(
  styles,
  {}
)(
  ({
    ...
    onClose,
    onConfirm
  }: SupplierAddressDialogProps & WithStyles<typeof styles>) => {
...
SupplierAddressDialog.displayName = "SupplierAddressDialog";
export default SupplierAddressDialog;
