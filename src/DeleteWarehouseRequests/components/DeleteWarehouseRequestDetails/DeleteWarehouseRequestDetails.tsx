...
const DeleteWarehouseRequestDetails: React.FC<SupplierDetailsProps> = props => {
...
DeleteWarehouseRequestDetails.displayName = "DeleteWarehouseRequestDetails";
export default DeleteWarehouseRequestDetails;
