...
export interface ExistProductInfoProps {
  data: {
    id: any
    status: string
    createdAt: string
...
const ExitProductInfo: React.FC<ExistProductInfoProps> = props => {
...
ExitProductInfo.displayName = "ExitProductInfo";
export default ExitProductInfo;
