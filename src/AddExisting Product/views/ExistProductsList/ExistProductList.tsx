...
interface ExistingProductListProps {
...
export const ExistingProductList: React.FC<ExistingProductListProps> = ({
  ...
  const { data, loading, refetch } = usesExistingProductListQuery({
    displayLoader: true,
  ...
  const [
    ...
    cleanupFn: reset,
    createUrl: existingProductListUrl,
    getFilterQueryParam,
    navigate,
    params
  });
  ...
  const { loadNextPage, loadPreviousPage, pageInfo } = paginate(
    maybe(() => data.requestsExistProduct.pageInfo),
    paginationState,
    params
  );
